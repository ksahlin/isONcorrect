...
original_reads_aligned=$outfolder"/sim_reads_aligned.sam" #$BASE_OUT"/data/chr6/1/uneven/reads.sam"
/usr/bin/time -v  minimap2 --eqx -t 8 -a -k9 -w1 -f 0.000001  $ref $sim_reads >  $original_reads_aligned
...
python $experiment_dir/get_abundance.py $original_reads_aligned $ref $original_reads   'original' >> $abundance_file
